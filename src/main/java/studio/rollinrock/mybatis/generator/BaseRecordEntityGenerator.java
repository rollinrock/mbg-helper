...
public class BaseRecordEntityGenerator extends BaseRecordGenerator {
    public BaseRecordEntityGenerator() {
        super();
    }
    ...
    public List<CompilationUnit> getCompilationUnits() {
        ...
        TopLevelClass topLevelClass = new TopLevelClass(introspectedTable
                .getBaseRecordType() + PropertyRegistry.JAVA_MODEL_CLASS_NAME_SUFFIX);
