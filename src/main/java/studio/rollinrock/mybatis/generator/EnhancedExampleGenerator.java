 ...
 * @description
 **/
public class EnhancedExampleGenerator extends AbstractJavaGenerator {

    private boolean tolerateNullValueByReturn;

    private boolean generateForJava5 = true;

    public EnhancedExampleGenerator(boolean tolerateNullValueByReturn) {
        super();
        this.tolerateNullValueByReturn = tolerateNullValueByReturn;
    }
