...
public class WochanyeExtMapperFilesPlugin extends PluginAdapter {
...
//        XmlElement extResultMap = new XmlElement("resultMap");
//        extResultMap.addAttribute(new Attribute("id", "ExtResultMap"));
//        extResultMap.addAttribute(new Attribute("type", introspectedTable.getBaseRecordType()));
//        extResultMap.addAttribute(new Attribute("extends", introspectedTable.getBaseResultMapId()));

//        root.addElement(extResultMap);
